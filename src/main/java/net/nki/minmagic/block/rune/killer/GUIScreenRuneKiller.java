...
public class GUIScreenRuneKiller extends AbstractContainerScreen<GUIMenuRuneKiller> {
    private final static HashMap<String, Object> guistate = GUIMenuRuneKiller.guistate;
    ...
    protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
        ...
        this.font.draw(poseStack, "Killer Rune", (this.imageWidth - this.font.width("Killer Rune")) / 2, 7, -12829636);
    }
