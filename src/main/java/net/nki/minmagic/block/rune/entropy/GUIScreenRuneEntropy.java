...
public class GUIScreenRuneEntropy extends AbstractContainerScreen<GUIMenuRuneEntropy> {
    private final static HashMap<String, Object> guistate = GUIMenuRuneEntropy.guistate;
    ...
    protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
        // TODO : Add translation component here
        this.font.draw(poseStack, "Entropy Rune", (this.imageWidth - this.font.width("Entropy Rune")) / 2, 7, -12829636);
    }
